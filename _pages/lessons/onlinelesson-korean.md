...
- 수강자는 녹화된 비디오를 다운로드 및  무제한 무료로 평생(ㅎ) 반복적으로 확인체크하며 연습할 수 있는 장점이 있습니다. <img src="https://jjmusic-online.github.io/assets/images/download.png" alt="JJ Photo of JJ" title="Photo of JJ" style="min-width: 50px" /> JJ Music 레슨생만의 특권입니다:)시공간에 제약을 받지 않는 편리하지만 지속가능한 평생의 여러분들의 피아노 공부를 도와 주는 온라인레슨입니다. 현재는 1:1 개인레슨으로만 진행합니다.

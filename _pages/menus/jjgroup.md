...
<section class="homepage-profile">
  <div class="homepage-profile__bio">
    <h2><span class="homepage-concerts__gold">JJ Group</span> <a href="/jjgroup/jjgroup-kor" style="font-size: 0.55em; font-weight: normal; margin-left: 0.6em; vertical-align: middle;">한국어로 보기 🇰🇷</a></h2>
...
<div class="homepage-videos">
  <div>
    {% include video id="Y4aycjElJHE" provider="youtube" %}
  </div>
  <div>
...
<div class="homepage-videos">
  ...
  <div>
    {% include video id="sw1LKL3cYMA" provider="youtube" %}
  </div>
  <div>
    {% include video id="qfDW6Ca28WM" provider="youtube" %}
  </div>
  <div>
    {% include video id="I2UoSQ36elU" provider="youtube" %}
  </div>
</div>
...
{% for concert in site.data.concerts %}
  ...
  {% if concert_date >= today %}
    {% assign upcoming = upcoming | push: concert %}
  {% else %}
    {% assign past = past | push: concert %}
  {% endif %}
{% endfor %}
...
<div class="homepage-concerts">
  <ul class="homepage-concerts__list">
    ...
    <li class="homepage-concerts__item">
      <span class="homepage-concerts__date">8:00 PM–10:00 PM (KST)</span>
      <span class="homepage-concerts__details">
        <span class="homepage-concerts__venue">
          ...
          — <strong>Secrets of Funk Piano</strong> Seminar
        </span>
        <span class="homepage-concerts__city"> · Online · In Korean</span>
        <br><span style="font-size:0.85em; opacity:0.85;">The JJ Music × 온맘다혜 collaboration seminar <em>Secrets of Funk Piano</em> will run from <strong>8:00 PM to 10:00 PM (Korean time)</strong>. 🎹</span>
        <br><img src="/assets/images/Screenshot%202026-06-25%20at%2016.31.49.png" alt="Secrets of Funk Piano Seminar" style="max-width:120px; width:100%; border-radius:4px; margin-top:6px; display:block;" />
      </span>
    </li>
  </ul>
</div>
  ...
  <div class="homepage-albums__grid">
    ...
    <div class="homepage-albums__item">
      ...
      <div class="homepage-albums__links">
        ...
        <a href="https://music.youtube.com/playlist?list=OLAK5uy_npc9lW305o3i3-2LxqEgn1ALvpxb_lUZg&si=-2SCwDi1VbaqQYCE" target="_blank" class="homepage-albums__link" style="color: #FF0000; border-color: #FF0000;">
          <i class="fab fa-youtube" aria-hidden="true"></i> YouTube Music
        </a>
        ...
        <a href="https://music.amazon.de/albums/B0G5BCPY17" target="_blank" class="homepage-albums__link" style="color: #FF9900; border-color: #FF9900;">
      ...
      <div class="homepage-albums__links">
        ...
        <a href="https://www.amazon.com/dp/B0G5BCQG7W/" target="_blank" class="homepage-albums__link" style="color: #FF9900; border-color: #FF9900;">
          <i class="fab fa-amazon" aria-hidden="true"></i> Amazon
        </a>
        <a href="https://jiyeonjeon.bandcamp.com/album/journey-together" target="_blank" class="homepage-albums__link" style="color: #1DA0C3; border-color: #1DA0C3;">
          <i class="fas fa-music" aria-hidden="true"></i> Bandcamp
        </a>
      </div>
    </div>
